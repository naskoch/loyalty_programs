...
equivalent to minimizing the influence zone. This result matches intuition - the faster
the merchant can get customers to adopt the reward program, the more transactions
it will make - but is stronger as it actually maximizes revenue as well. Although reward
point accelerations are common and effective mechanisms to minimize the zone of influence,
we have shown that this result can also be achieved through optimal reward scheme design as well.
