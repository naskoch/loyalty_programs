...
\begin{theorem}
Under proportional promotion budgeting, the optimal reward distance ($k$) and the optimal budget proportion ($\alpha$) for merchant $A$ follow the relation $\alpha k = \frac{e}{(1-\beta)}$ for all distributions of $\lambda$ as long as $\beta$ is close to 1.
\end{theorem}
\proof{Proof.}
...
\centering
\includegraphics[height=2in]{\figurefolder/rora_alpha_unif_v2.png}
\caption{Uniform distribution.}
\end{subfigure}%
~ 
\begin{subfigure}[t]{0.5\textwidth}
\centering
\includegraphics[height=2in]{\figurefolder/rora_alpha_normal_v2.png}
\caption{Normal distribution.}
\end{subfigure}
\centering
\begin{subfigure}[t]{0.5\textwidth}
\centering
\includegraphics[height=2in]{\figurefolder/rora_alpha_logit_v2.png}
...
\begin{figure*}[t]
\centering
\includegraphics[scale = 0.4]{\figurefolder/b_region_v2.png}
...
\begin{figure}[h!]
\begin{centering}
\includegraphics[scale = 0.55]{\figurefolder/b_bounds.png}
