...
The authors attributed this behavior to Goal Gradient Hypothesis (\cite{hull1932goal}). {\nolan This behavior is also very prevalent in online badge systems, such as those on Stackoverflow; recently, mathematical models relying on rational user behavior have been developed that explain this phenomenon \cite{leskovec2013steering}.}
