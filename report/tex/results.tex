...
>>>>>>> 352b253d9bc2d83ed95464e4aa1f2f18e2fa624d
...
\begin{lemma}
As $\alpha \rightarrow e$, for the reward program to be strictly better, a necessary condition on $p$ is:
\beq
\label{eq:necp}
...
\begin{lemma}
As $\alpha \rightarrow e$ and $p$ obeying Eq.~\ref{eq:necp}, as $p$ increases, the range of value of $b$ for which reward program is strictly better increases.
\end{lemma}
\begin{proof}
\end{proof}
