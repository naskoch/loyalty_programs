...
We refer to the ratio of number of visits required for a strategic customer to adopt a reward program and the total distance to the reward as the ``influence zone''.
